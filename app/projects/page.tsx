...
const page = () => {
  return (
    <div className='flex flex-col bg-gradient-to-r from-slate-800 via-slate-900 to-black min-h-screen p-4 justify-center items-center'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-7 p-4 m-2 transition-all duration-700'>
        <Cards title="Ai Logo Generator" description="AI Logo Maker — A modern web app built with Next.js, ShadCN UI, and React, enabling users to generate unique logos via Gemini API and Hugging Face models. Enter your brand ideas as text prompts and get stunning, AI-generated logos in seconds." image="/ai-logo-maker.png" link="https://github.com/adithyasd10/ai-logo-maker" link1="/projects"/>
      </div> 
    </div>
