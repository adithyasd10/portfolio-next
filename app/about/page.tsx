...
const Aboutpage = () => {
  return (
    <div className='flex flex-col justify-start text-start p-40 gap-4 bg-gradient-to-r from-blue-200 via-blue-300 to-blue-700 min-h-screen'>
