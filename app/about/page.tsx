  ...
  return (
    <div className='flex flex-col justify-start text-start p-40 gap-4 bg-gradient-to-r from-slate-800 via-slate-900 to-black min-h-screen items-center'>
        <div className='flex flex-col gap-3  '>
            <h1 className='flex justify-center text-3xl md:text-6xl text-start bg-clip-text text-transparent bg-gradient-to-r from-gray-800 via-white to-black font-extrabold hover:from-gray-300 hover:via-gray-600 hover:to-white hover:hover:scale-95 hover:transition-transform'>ABOUT</h1>
